...
# to run: sbatch -a 0-89 SubSample.zika.sh "0.10" "/scratch/kej310/ZIKA/ZikaDVG/rmdup_bams/" "/scratch/kej310/ZIKA/ZikaDVG/" "/scratch/kej310/ZIKA/ZikaDVG/reference/zika/MR766.ZIKA.CDS.fas" "ZIKA"
module purge
...
python readreport_v5_1.py --strain "${STRAIN}_${FRAC}" --infile ./${NAME}.${FRAC}.sorted.bam --ref ${REFSEQ}
