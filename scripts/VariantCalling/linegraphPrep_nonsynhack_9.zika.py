"""
Updated 10/21/2020 KJ
For zika subsample files only
"""
...
STRAIN = 'ZIKA_0.10'  # strain using, h3n2, h1n1, zika, etc.
path = '../../SubVariants/Sub10/'  # where the snplist files are
savedirect = "../../SubVariants/Sub10/"  # where save file
...
MINORFREQ_CUTOFF = 0.02  # minimum frequency cutoff
COVERAGE_CUTOFF = 200  # need this coverage for minor variant
MINCOVERAGE = 100  # need this coverage for 'major' nucleotide
